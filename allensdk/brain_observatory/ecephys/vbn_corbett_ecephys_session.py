...
from allensdk.brain_observatory.behavior.vbn_corbett_session import \
    VBNCorbettSession
...
class VBNCorbettBehaviorSession(VBNCorbettSession):
    """
...
class VBNCorbettEcephysSession(VBNCorbettBehaviorSession):
    """
    ...
    def __init__(
            self,
            behavior_session: VBNCorbettSession,
    ...
    def from_json(
        ...
        return VBNCorbettEcephysSession(
