...
class _VBNOptoSessionDataSchema(BaseBehaviorSessionDataSchema,
                            BaseNeuropixelsSchema):
...
class OutputSchema(RaisingSchema):
    input_parameters = argschema.fields.Nested(VBNOptoInputSchema)
    output_path = argschema.fields.OutputFile(
        required=True,
